...
class DocksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dock" do
    assert_difference('Dock.count') do
      post docks_url, params: { dock: { available: @dock.available, dock_number: @dock.dock_number } }
    end
  ...
  test "should update dock" do
    patch dock_url(@dock), params: { dock: { available: @dock.available, dock_number: @dock.dock_number } }
